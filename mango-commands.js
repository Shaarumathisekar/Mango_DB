...
db.movies.countDocuments()//this is also for count
...
//mix
db.movies.find({}, { summary: 1, trailer: 0 })
//- it shows mongoserverError;

//Exception- we will do _id for mix of inclusion and exclusion projections
db.movies.find({}, { _id: 0, summary: 0, trailer: 0 })

//Sorting
db.movies.find({}, { name: 1, rating: 1 }).sort({ rating: 1 })//-asc
db.movies.find({}, { name: 1, rating: 1 }).sort({ rating: -1 })//-desc
